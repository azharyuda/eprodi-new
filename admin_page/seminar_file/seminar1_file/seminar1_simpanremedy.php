...
unlink($loc.$sarat);
     ...
     $mail->Subject = 'Status Pendaftaran Ujian Ulang Seminar Proposal';
     $mail->Body=
"Pendaftaran Ujian Ulang Seminar Proposal anda tidak dapat diterima dikarenakan adanya persyaratan yang kurang yaitu:
        ...
        if(empty($dosenusul) || empty($kd) ||  empty($nim)){
         ...
         window.location='index2.php?ke=sempr0_konfdaftar&kd=$kd'</script>";
          ...
          WHERE kode_daftar='$kd' ") or die (mysqli_error());
            ...
            $mail->Subject = 'Status Pendaftaran Ujian Ulang Seminar Proposal';
            $mail->Body=
"Pendaftaran Ujian Ulang Seminar Proposal anda telah diterima dengan detail sebagai berikut:
