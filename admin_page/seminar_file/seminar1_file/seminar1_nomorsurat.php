...
<section class="main page-header">
  <h4><i class="fa fa-downlo fa-fw" style="color: #9150B4;"></i> Halaman Input Nomor Surat Seminar Proposal</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw">&nbsp;</i><a href="index2.php?ke=home">Dashboard</a></li>
    <li><a href="index2.php?ke=semh4s_jdwl">Jadwal Seminar Proposal</a></li>
    <li class="active">Input Nomor Surat Seminar Proposal</a></li>
  </ol>
</section>

<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Input Nomor Surat Seminar Proposal</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="../admin_page/undangan/undanganSEMPRO.php" method="POST" id="frm-surat">
