<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Seminar Proposal</h4>
  <ol class="breadcrumb">
      ...
      <table class="table table-bordered table-striped" id="table-data">
        ...
        <?php
            ...
            $ambil = $link->query("SELECT tbldaftarseminar_skripsi.kode_daftar, tbldaftarseminar_skripsi.NIM, tblmahasiswa.nm_mahasiswa, tblmahasiswa.judul_skripsi,
                                    ...
                                    usulan_dosen
                                    FROM tbldaftarseminar_skripsi JOIN tblmahasiswa ON tbldaftarseminar_skripsi.NIM=tblmahasiswa.NIM AND tbldaftarseminar_skripsi.pilihan_seminar='Seminar 1' WHERE status='Menunggu Konfirmasi' ORDER BY tgl_input")
                                    or die (mysqli_error());
        ...
        <tr>
          ...
          <td class="text-center"><a class="btn btn-success" data-toggle="tooltip" title="Konfirmasi Pendaftaran" href="index2.php?ke=sempr0_konfdaftar&kd=<?php echo $tampil['kode_daftar']; ?>"><i class="fa fa-check fa-fw"></i></a>
          </td>
        </tr>
