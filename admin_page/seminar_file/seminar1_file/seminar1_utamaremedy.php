<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Ujian Ulang Seminar Proposal</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw"> </i><a href="index2.php?ke=home"> Dashboard</a></li>
    <li class="active">Halaman Konfirmasi Ujian Ulang Seminar Proposal</li>
  </ol>
</section>
...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>
       Data Pendaftar Ujian Ulang Seminar Proposal Skripsi</center></b>
    </div>
    <br />
      ...
      <table class="table table-bordered table-striped" id="table-data">
        ...
        <?php
            ...
            $ambil = $link->query("SELECT tbldaftarseminar_skripsi.kode_daftar, tbldaftarseminar_skripsi.NIM, tblmahasiswa.nm_mahasiswa, tblmahasiswa.judul_skripsi,
                                    tgl_input, status, persyaratan1, dir_persyaratan, tblmahasiswa.dosbing1, tblmahasiswa.dosbing2,
                                    usulan_dosen
                                    FROM tbldaftarseminar_skripsi JOIN tblmahasiswa ON tbldaftarseminar_skripsi.NIM=tblmahasiswa.NIM
                                    AND tbldaftarseminar_skripsi.pilihan_seminar='Seminar 1'
                                    WHERE status='Menunggu Konfirmasi Ujian Ulang' ORDER BY tgl_input")
                                    or die (mysqli_error());
        ...
        <tr>
          ...
          <td class="text-center"><a class="btn btn-success" data-toggle="tooltip" title="Konfirmasi Pendaftaran" href="index2.php?ke=sempr0_konfremedy&kd=<?php echo $tampil['kode_daftar']; ?>"><i class="fa fa-check fa-fw"></i></a>
          </td>
        </tr>
