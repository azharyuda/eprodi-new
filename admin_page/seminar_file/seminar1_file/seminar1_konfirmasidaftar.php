<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Pendaftaran Seminar 1</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw">&nbsp;</i><a href="index2.php?ke=home">Dashboard</a></li>
    <li><a href="index2.php?ke=sempr0">Seminar 1</a></li>
    <li class="active">
      Konfirmasi Pendaftaran Seminar 1
    </li>
  </ol>
</section>
<?php
...
<div class="panel panel-warning">
    ...
    <form class="form-horizontal required" action="index2.php?ke=sempr0_smpndaftar" method="POST" id="frm-sem">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          ...
          <option hidden value="">Pilih</option>
            <?php
            $qry=$link->query("SELECT *  FROM tbldosen WHERE kuota_penguji1>0 AND nm_dosen!='$data2[dosbing1]' AND nm_dosen!='$data2[dosbing2]' AND nm_dosen!='$data[usulan_dosen]' order by nm_dosen") or die(mysqli_error());
            while ($data=$qry->fetch_array()){
