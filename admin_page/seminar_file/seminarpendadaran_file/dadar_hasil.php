<section class="main page-header">
  <h4><i class="fa fa-download fa-fw" style="color: #9150B4;"></i> Halaman Input Hasil Seminar Pendadaran</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw">&nbsp;</i><a href="index2.php?ke=home">Dashboard</a></li>
    <li><a href="index2.php?ke=semh4s_jdwl">Jadwal Seminar Pendadaran</a></li>
    <li class="active">Hasil Seminar Pendadaran</a></li>
  </ol>
</section>

<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Input Hasil Seminar Pendadaran Skripsi</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=d4r_smpnhsl" method="POST">
    ...
    <?php } ?>
      ...
      <div class="form-group">
        <label class="control-label col-sm-2">Nilai Akhir Pendadaran: </label>
        <div class="col-sm-5">
          <input type="text" class="form-control required" name="_nilai_dadar" id="dadar" readonly>
        </div>
      </div>
      <?php
      $qry=$link->query("SELECT nilai_akhir FROM tblseminar_2 WHERE NIM=$data[NIM] AND hasil_seminar2='Lulus'");
      $take=$qry->fetch_array();

       ?>
      <div class="form-group">
        <label class="control-label col-sm-2">Nilai Akhir Seminar 2: </label>
        <div class="col-sm-5">
          <input type="text" class="form-control required" name="_nilai_sem2" id="sem2" readonly value="<?php echo $take['nilai_akhir']; ?>" onkeyup="sum();">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2">Nilai Akhir Skripsi: </label>
        <div class="col-sm-5">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <select class="form-control" name="_hasil_dadar" onchange="ceklulus(this)">
...
function sum() {
      ...
      var dadar = ((parseInt(dosbing1) + parseInt(dosbing2) + parseInt(uji1) + parseInt(uji2))/4)*(0.8);
      if (!isNaN(dadar)) {
         document.getElementById('dadar').value = dadar;
         var akhir=parseInt(dadar) + parseInt(sem2);
        if (!isNaN(akhir)) {
