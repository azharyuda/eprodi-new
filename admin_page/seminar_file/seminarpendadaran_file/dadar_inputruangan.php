...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Seminar Pendadaran Skripsi</center></b>
    </div>
    <br />
    ...
    <?php
      ...
      $qry=$link->query("SELECT * FROM tblseminar_pendadaran WHERE kode_daftar='$kod'") or die(mysqli_error());
      while ($data=$qry->fetch_array())
      {
    ?>

    <form class="form-horizontal required" action="index2.php?ke=d4r_smpn" method="POST" id="frm-tgl">
      <div class="form-group">
        ...
        <div class="col-sm-5">
          ...
          <input type="text" class="form-control required" name="_kod" value="<?php echo $data['kode_daftar']; ?>" readonly="readonly" style="display: none;">
        </div>
      </div>
