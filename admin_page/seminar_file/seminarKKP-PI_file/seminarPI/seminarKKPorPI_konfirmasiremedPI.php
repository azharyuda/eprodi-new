...
<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Pendaftaran Ujian Ulang Seminar KKP atau PI</h4>
  <ol class="breadcrumb">
...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Ujian Ulang Seminar PI</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=P1_smpnremed" method="POST" id='frm-kkpi'>
