      ...
      <table class="table table-bordered table-striped" id="table-data">
        ...
        <?php
            ...
            $ambil = $link->query("SELECT tbldaftarseminar_kkporpi.kode_daftar, tbldaftarseminar_kkporpi.NIM, tblmahasiswa.nm_mahasiswa,
                                    ...
                                    WHERE pilihan_KKPorPI='PI' AND status='Menunggu Konfirmasi'
                                     ORDER BY tgl_input");
          ...
          <td><a class="btn btn-success" data-toggle="tooltip" title="Konfirmasi Pendaftaran" href="index2.php?ke=P1_konf&kode=<?php echo $tampil['kode_daftar']; ?>"><i class="fa fa-check fa-fw"> </i>Konfirmasi</a>
          </td>
        </tr>
