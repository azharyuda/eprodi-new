...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Seminar KKP atau PI</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=P1_smpn" method="POST" id='frm-kkpi'>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <textarea class="form-control required" name="_syarat" id="sarat" style="display:none;" placeholder="Isi Persyaratan yang kurang" maxlength="50"></textarea>
            </div>
          </div>

      <div class="form-group">
        <label class="control-label col-sm-2" id="ub"style="display:none;">Apakah dosen penguji dirubah?</label>
        <div class="col-sm-5">
          <select class="form-control required" name="_dosen_ubah" id="dosen_ubah" onchange="cek_ubah(this)" style="display:none;">
              <option hidden value="">Pilih</option>
              <option value="gaada">Tidak ada perubahan</option>
              <option value="ada">Dirubah</option>
          </select>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" id="lbluji1" style="display: none;">Dosen Penguji 1: </label>
        <div class="col-sm-5">
          <select class="form-control required" name="_dosenuji1" id="dosenuji1" style="display: none;">
              <option hidden value="">Pilih</option>
              <?php
                $qry = $link->query("SELECT NIDN, nm_dosen from tbldosen where nm_dosen !='$data2[dosen_wali]' and kuotapenguji1_kkpi>0 order by nm_dosen");
                while ($data = $qry->fetch_array())
                {
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" id="lbluji2"  style="display: none;">Dosen Penguji 2: </label>
            <div class="col-sm-5">
              <select class="form-control required" name="_dosenuji2" id="dosenuji2" style="display: none;">
                  <option hidden value="">Pilih</option>
                  <?php
                    $qry = $link->query("SELECT NIDN, nm_dosen from tbldosen where nm_dosen !='$data2[dosen_wali]' and kuotapenguji2_kkpi>0 order by nm_dosen");
                    while ($data = $qry->fetch_array())
                    {
                    echo "<option value='$data[nm_dosen]'>$data[nm_dosen]</option>";
                    }
      ...
      <div class="form-group">
        <label class="control-label col-sm-2" id="lbl_ubah" style="display:none;">Alasan Dosen Penguji dirubah: </label>
        <div class="col-sm-5">
          <textarea class="form-control required" name="_alasan_ubah" id="alasan_ubah" style="display:none;" placeholder="Isi Alasan Perubahan" maxlenght="200"></textarea>
        </div>
      </div>
    <?php }} ?>
  </form>
