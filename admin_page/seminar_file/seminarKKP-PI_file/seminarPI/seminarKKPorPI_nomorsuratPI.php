...
<section class="main page-header">
  <h4><i class="fa fa-download fa-fw" style="color: #9150B4;"></i> Halaman Input Nomor Surat Undangan Seminar PI</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw">&nbsp;</i><a href="index2.php?ke=home">Dashboard</a></li>
    <li><a href="index2.php?ke=kkp_jdwl">Jadwal Seminar PI</a></li>
...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Input Nomor Surat Undangan Seminar PI</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="../admin_page/undangan/undanganPI.php" method="POST" id="frm-surat">
