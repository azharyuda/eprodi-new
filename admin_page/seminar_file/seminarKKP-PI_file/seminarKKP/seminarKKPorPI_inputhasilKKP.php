...
<section class="main page-header">
  <h4><i class="fa fa-download fa-fw" style="color: #9150B4;"></i> Halaman Input Hasil Seminar KKP</h4>
  <ol class="breadcrumb">
...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Input Hasil Seminar KKP</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=kkP_smpnhsl" method="POST">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <select class="form-control" name="_hasil_seminarKKP" onchange="ceklulus(this)">
