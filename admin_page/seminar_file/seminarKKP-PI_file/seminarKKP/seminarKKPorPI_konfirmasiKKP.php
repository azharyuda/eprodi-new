...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Seminar KKP</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=kkP_smpn" method="POST" id="frm-kkpi">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
        <input type="text" class="form-control required" name="_alasan_ubah" id="alasan_ubah" style="display:none;">
      </div>
    </div>
  <?php }} ?>
  </form>
