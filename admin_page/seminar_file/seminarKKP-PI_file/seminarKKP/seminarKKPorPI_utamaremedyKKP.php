...
<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Ujian Ulang Seminar KKP</h4>
  <ol class="breadcrumb">
      ...
      <table class="table table-bordered table-striped" id="table-data">
        ...
        <?php
            ...
            $ambil = $link->query("SELECT tbldaftarseminar_kkporpi.kode_daftar, tbldaftarseminar_kkporpi.NIM, tblmahasiswa.nm_mahasiswa,
                                    ...
                                    WHERE pilihan_KKPorPI='KKP' and status='Menunggu Konfirmasi Ujian Ulang'
                                     ORDER BY tgl_input")
                                    or die (mysqli_error());
          ...
          <td><a class="btn btn-success" data-toggle="tooltip" title="Konfirmasi Pendaftaran" href="index2.php?ke=kkP_konfremed&kode=<?php echo $tampil['kode_daftar']; ?>"><i class="fa fa-check fa-fw"> </i>Konfirmasi</a>
          </td>
        </tr>
