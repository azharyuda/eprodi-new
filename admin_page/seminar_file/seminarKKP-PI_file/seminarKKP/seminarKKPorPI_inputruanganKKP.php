...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Seminar Kuliah Kerja Praktek</center></b>
    </div>
    <br />
    ...
    <?php
      ...
      $qry=$link->query("SELECT * FROM tblseminar_kkp WHERE kode_daftar='$kode'") or die(mysqli_error());
      while ($data=$qry->fetch_array())
      {
    ?>

    <form class="form-horizontal required" action="index2.php?ke=kkP_ruangsmpn" method="POST" id="frm-tgl">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <textarea name="_judul_KKPorPI" class="form-control" readonly="readonly"><?php echo $data['judul_kkp']; ?></textarea>
        </div>
      </div>
