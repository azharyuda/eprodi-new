<section class="main page-header">
  <h4><i class="fa fa-check-circle fa-fw" style="color: #9150B4;"></i> Halaman Konfirmasi Input Ruangan Seminar 2</h4>
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard fa-fw">&nbsp;</i><a href="index2.php?ke=home">Dashboard</a></li>
    <li><a href="index2.php?ke=semh4s">Seminar 2</a></li>
    <li class="active">
      Input Ruangan Seminar 2
    </li>
  </ol>
</section>
...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Seminar 2 Skripsi</center></b>
    </div>
    <br />
    ...
    <?php
      ...
      $qry=$link->query("SELECT * FROM tblseminar_2 WHERE kode_daftar='$kod'") or die(mysqli_error());
      while ($data=$qry->fetch_array())
      {
    ?>

    <form class="form-horizontal required" action="index2.php?ke=semh4s_smpn" method="POST" id="frm-tgl">
