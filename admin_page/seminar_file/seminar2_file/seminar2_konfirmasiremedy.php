...
<div class="panel panel-warning">
    <div class="panel-heading">
       <b><center>Konfirmasi Pendaftaran Ujian Ulang Seminar 2</center></b>
    </div>
    <br />
    ...
    <form class="form-horizontal required" action="index2.php?ke=semh4s_smpnremedy" method="POST" id="frm-sem">
