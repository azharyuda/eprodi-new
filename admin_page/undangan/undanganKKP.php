...
<?php
  ...
  $qry=$link->query("SELECT *,tblmahasiswa.nm_mahasiswa FROM tblseminar_kkp
    JOIN tblmahasiswa ON tblseminar_kkp.NIM=tblmahasiswa.NIM WHERE kode_daftar='$kode'");
 ...
 <br />
 <br />
<b>Perihal&nbsp; &nbsp; &nbsp; :</b> Ujian Seminar Kuliah Kerja Praktek <?php echo "<b>$nm</b> <b>($nim)</b>"; ?>
 <br />
 <br />
 <br />
  Kepada Yth.
...
<br />
 ...
 Dengan Hormat,
<p>
  Sehubungan dengan pelaksanaan <b>Ujian Seminar Kuliah Kerja Praktek Jenjang S1 Sistem
  Informasi</b>, bersama ini kami mohon kesediaan Bapak/Ibu untuk dapat hadir pada acara
  ujian Seminar Kuliah Kerja Praktek yang diadakan:
</p>
<p>
...
<p>
 ...
 ujian Seminar Kuliah kerja Praktek yang diadakan pada:
</p>
<p>
  Hari / tanggal &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;: <?php echo $hari.",&nbsp;".$tglmajudiambil; ?><br />
  Waktu &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Pk <?php echo $jam; ?> Wita Selesai<br />
