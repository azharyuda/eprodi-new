...
<?php
  ...
  $qry=$link->query("SELECT *,tblmahasiswa.nm_mahasiswa FROM tblseminar_pendadaran
    JOIN tblmahasiswa ON tblseminar_pendadaran.NIM=tblmahasiswa.NIM WHERE kode_daftar='$kode'");
 ...
 <br />
 <br />
<b>Perihal&nbsp; &nbsp; &nbsp; :</b> Ujian Seminar Pendadaran Skripsi <?php echo "<b>$nm</b> <b>($nim)</b>"; ?>
 <br />
 <br />
 <br />
  Kepada Yth.
 <br />
   <b>Dosen Pembimbing I</b>
   <br />
...
<br />
 ...
 Dengan Hormat,
<p>
  Sehubungan dengan pelaksanaan <b>Ujian Seminar Pendadaran Skripsi Jenjang S1 Sistem
  Informasi</b>, bersama ini kami mohon kesediaan Bapak/Ibu untuk dapat hadir pada acara
  Ujian Seminar Pendadaran Skripsi yang diadakan:
</p>
<p>
...
Dengan Hormat,
<p>
 Sehubungan dengan pelaksanaan <b>Ujian Seminar Pendadaran Skripsi S1 Sistem
 Informasi</b>, bersama ini kami mohon kesediaan Bapak/Ibu untuk dapat hadir pada acara
 Ujian Seminar Pendadaran Skripsi yang diadakan:
</p>
<p>
...
<p>
 ...
 Ujian Seminar Pendadaran Skripsi yang diadakan pada:
</p>
<p>
  Hari / tanggal &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;: <?php echo $hari.",&nbsp;".$tglmajudiambil; ?><br />
  Waktu &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Pk <?php echo $jam; ?> Wita Selesai<br />
