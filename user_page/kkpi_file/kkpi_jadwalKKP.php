<?php
 ...
 <section class="main page-header">
     <h2><i class="fa fa-calendar fa-fw" aria-hidden="true" style="color: #9150B4;"></i> Jadwal Seminar Kuliah Kerja Praktek Mahasiswa SI STMIK Widya Cipta Dharma Samarinda</h2>
 </section>

<div class="panel panel-primary">
    <div class="panel-heading">
      <center>
        Jadwal Seminar KKP Mahasiswa:
      </center>
    </div>
        ...
        <table class="table table-bordered table-striped" id="table-data" >
          ...
          <tbody>
            <?php
                ...
                $ambil = $link->query("SELECT *, tblmahasiswa.nm_mahasiswa FROM tblseminar_kkp
                  JOIN tblmahasiswa ON tblseminar_kkp.NIM=tblmahasiswa.NIM
                where hasil_seminarkkp='Menunggu selesai seminar'") or die (mysqli_error());
